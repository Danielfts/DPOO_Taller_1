...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. (Taller) Buscar pais que representa un Atleta");
	...
	{
		String name = input("Ingrese nombre del atleta");
		System.out.println(calculadora.buscarPaisAtleta(name));
	}
